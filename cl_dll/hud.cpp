...
void CHud::Init()
{
...
#ifdef DEBUG
	m_pFlashlightCvarDecayRange = CVAR_CREATE( "cl_flashlight_decay_range", "512", FCVAR_ARCHIVE );
	...
	m_pFlashlightCvarTargetDistance = CVAR_CREATE( "cl_flashlight_target_distance", "16", FCVAR_ARCHIVE );
